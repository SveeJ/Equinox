                        ...
                        return __generator(this, function (_s) {
                            switch (_s.label) {
                                ...
                                case 1:
                                    ...
                                    if (!constants_1.Constants.QUEUES_ARRAY.includes(newState.channelID))
                                        return [2 /*return*/];
                                ...
                                case 4:
                                    ...
                                    index = constants_1.Constants.QUEUES_ARRAY.indexOf(queueChannel.id);
                                    index = index <= 6 ? 0 : index <= 8 ? 1 : index - 7;
